    ...
    <footer className="bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4 animate-fade-in-up">
            ...
            <div className="flex gap-3 pt-2">
              <a
                href="https://instagram.com/upi_official"
                target="_blank"
          ...
          <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#faculties" className="text-gray-300 hover:text-white transition flex items-center gap-2">
                  <ExternalLink className="w-4 h-4" />
                  Fakultas & Prodi
                </a>
              </li>
              <li>
                <a href="#admission" className="text-gray-300 hover:text-white transition flex items-center gap-2">
                  <ExternalLink className="w-4 h-4" />
                  Pendaftaran
                </a>
              </li>
          ...
          <div className="space-y-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:pmb@upi.edu" className="text-gray-300 hover:text-white transition">
                  pmb@upi.edu
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">(+62) 274-285</span>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">Jl. Setiabudhi No. 229, Bandung 40154</span>
              </li>
            </ul>
          </div>
        ...
        <div className="text-center text-sm text-gray-400">
          <p>
            &copy; 2026 Universitas Pendidikan Indonesia. Semua hak dilindungi. | Dirancang dengan
            <span className="text-red-600"> ❤ </span>
            oleh UPI Digital Team
          </p>
        </div>
      </div>
    </footer>
